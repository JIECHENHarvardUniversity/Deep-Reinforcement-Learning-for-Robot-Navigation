...
class Maze(tk.Tk, object):
    ...
    def _build_maze(self):
        ...
        # hell
        hell1_center = origin + np.array([UNIT * 2, UNIT * 3])
        ...
        # hell
        for i in range(4,11):
            hell8_center = origin + np.array([UNIT * i, UNIT * 11])
        ...
        # hell
        for i in range(5,9):
            hell9_center = origin + np.array([UNIT * 4, UNIT * i])
